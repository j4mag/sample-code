classdef CollabPlayer < Player
    %COLLABPLAYER This is an Arknights player that uses their clues
    %collaboratively
    %   A collaborative player trades all their clues whenever, only 
    %   using them when it triggers a party. This differs from a selfless
    %   player only in how clues are given out, prioritizing the most
    %   generous friends.
    properties
    ...
    methods
        function self = CollabPlayer(id)
            %COLLABPLAYER Construct an instance of this class
            %   Inputs:
